...
if __name__ == "__main__":
    ...
    load_response = make_authorized_request(
        ...
        data={
            ...
            "input_columns": ["Age", "Income", "Loan_Amount", "Loan_Term", "Credit_Score", "Marital_Status"],  # Adjust input features
            "label_column": "Loan_Status",  # Label column
        },
    )
    print(load_response)
    ...
    predict_response = make_authorized_request(
        "/predict",
        data={
            "input_values": [[30, 80000, 30000, 48, 750, 1]]  # Age, Income, Loan_Amount, Loan_Term, Credit_Score, Marital_Status  # Example input: Age 30, Income 80k, Loan 30k, etc.
        },
    )
